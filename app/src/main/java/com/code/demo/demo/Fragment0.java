 ...
 */
public class Fragment0 extends Fragment implements View.OnClickListener, TextWatcher {
  ...
  List<Class> list = new ArrayList<Class>() {{
      list.add(FastTitleSimpleActivity.class);
  }};

  @Override
  public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
      @Nullable Bundle savedInstanceState) {
    View layout = inflater.inflate(R.layout.fragment_0, null);
    init(layout);
    return layout;
  }
