...
public class NetWorkTypeUtils {
    ...
    public static void openWirelessSettings() {
        CFrame.mApplicationContext.startActivity(
    ...
    public static boolean getWifiEnabled() {
        ...
        WifiManager manager = (WifiManager) CFrame.mApplicationContext.getSystemService(WIFI_SERVICE);
    ...
    public static String getNetworkOperatorName() {
        TelephonyManager tm =
                (TelephonyManager) CFrame.mApplicationContext.getSystemService(Context.TELEPHONY_SERVICE);
    ...
    public static String getServerAddressByWifi() {
        @SuppressLint("WifiManagerLeak")
        WifiManager wm = (WifiManager) CFrame.mApplicationContext.getSystemService(Context.WIFI_SERVICE);
        if (wm == null) {
            return "";
        }
