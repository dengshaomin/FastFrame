...
public class XRefreshView extends LinearLayout {
    ...
    private boolean enableRecyclerViewPullDown = true;
    /**
...
//        if(mHolder.mOffsetY!=0)return;
    ...
    private void updateHeaderHeight(int currentY, int deltaY, int... during) {
        ...
        if (isAutoRefresh) {
            ...
            if (!enableRecyclerViewPullDown && !mEnablePullRefresh) return;
...
//        mFooterCallBack.onStateRefreshing();
    ...
    public void enableRecyclerViewPullDown(boolean enable) {
        enableRecyclerViewPullDown = enable;
    }
