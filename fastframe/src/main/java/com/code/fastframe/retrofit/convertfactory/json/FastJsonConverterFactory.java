package com.code.fastframe.retrofit.convertfactory.json;
...
public class FastJsonConverterFactory extends Converter.Factory {
    ...
    public FastJsonConverterFactory setParserConfig(
        ParserConfig config) {
    ...
    public FastJsonConverterFactory setParserFeatures(
        Feature[] features) {
    ...
    public FastJsonConverterFactory setSerializeConfig(
